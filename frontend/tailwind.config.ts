...
export default {
  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        'soft': '0 1px 2px 0 hsl(160 20% 10% / 0.03)',
        'elevated': '0 4px 12px -2px hsl(160 20% 10% / 0.06)',
        'float': '0 12px 32px -4px hsl(160 20% 10% / 0.08)',
        'glow': '0 0 24px -4px hsl(152 55% 40% / 0.18)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
